...
import kotlinx.android.synthetic.main.layout_header_bar_gray.view.*


class HeaderBarGray @JvmOverloads constructor(
    ...
    private fun initView() {
        View.inflate(context, R.layout.layout_header_bar_gray,this)
        mblueLeftIv.visibility = if (isShowBack) View.VISIBLE else View.GONE

        //标题不为空，设置值
        titleText?.let {
            mgrayTitleTv.text = it
        }
