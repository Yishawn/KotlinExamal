...
public class ZoomImageView extends android.support.v7.widget.AppCompatImageView implements OnScaleGestureListener,
		...
		mGestureDetector = new GestureDetector(context,
				new SimpleOnGestureListener() {
					...
					public boolean onDoubleTap(MotionEvent e) {
						...
						float x = e.getX();
						float y = e.getY();
						Logger.e("DoubleTap", getScale() + " , " + initScale);
	...
	private void checkBorderAndCenterWhenScale() {
		...
		Logger.e(TAG, "deltaX = " + deltaX + " , deltaY = " + deltaY);
	...
	public void onGlobalLayout() {
		if (once) {
			...
			if (d == null)
				return;
			Logger.e(TAG, d.getIntrinsicWidth() + " , " + d.getIntrinsicHeight());
			int width = getWidth();
			int height = getHeight();
			// 拿到图片的宽和高
			...
			Logger.e(TAG, "initScale = " + initScale);
