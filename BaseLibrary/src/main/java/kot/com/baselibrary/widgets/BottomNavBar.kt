...
class BottomNavBar @JvmOverloads constructor(
    ...
    init {
        ...
        //产品
        val productItem=BottomNavigationItem(R.drawable.btn_nav_product_press,resources.getString(R.string.nav_bar_category))
                .setInactiveIconResource(R.drawable.btn_nav_product_normal)
                .setActiveColorResource(R.color.common_blue)
                .setInActiveColorResource(R.color.text_normal)
//        //财富
        val treasureItem=BottomNavigationItem(R.drawable.btn_nav_treasure_press,resources.getString(R.string.nav_bar_msg))
                .setInactiveIconResource(R.drawable.btn_nav_treasure_normal)
                .setActiveColorResource(R.color.common_blue)
                .setInActiveColorResource(R.color.text_normal)
        //我的
